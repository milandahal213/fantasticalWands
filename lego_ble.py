...
class LegoDevice:
    ...
    def scan_and_connect(self, name_filter=None):
        ...
        # Enable notifications (write 0x0001 to the CCCD descriptor)
        # MicroPython's gattc_write with mode=1 enables notifications
        self._ble.gattc_write(self._conn_handle, self._notif_handle - 1,
                              struct.pack("<H", 1), 1)
        time.sleep_ms(100)
        print("Ready.")
